...
async function seed() {
	...
	try {
		...
		await db.insert(mstVendors).values([
			{
				id: 1,
				name: "MarineTech Supplies",
				category: "Sparepart",
				email: "sales@marinetech.fake",
				phone: "08123456789",
			},
			{
				id: 2,
				name: "Oceanic Fuel Co",
				category: "Fuel",
				email: "bunker@oceanic.fake",
				phone: "08987654321",
			},
			{
				id: 3,
				name: "SafeHull Services",
				category: "Jasa",
				email: "service@safehull.fake",
				phone: "08221122334",
			},
		]);
