...
import {
	addMappingSchema,
	removeMappingSchema,
} from "./module-access.validation.ts";
...
router.post(
	...
	apiAuth(),
	roleAuth(),
	validate(addMappingSchema),
	moduleAccessController.addMapping,
);
router.delete(
	"/",
	apiAuth(),
	roleAuth(),
	validate(removeMappingSchema),
	moduleAccessController.removeMapping,
);
